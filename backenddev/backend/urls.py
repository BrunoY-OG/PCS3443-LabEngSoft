...
urlpatterns = [
    ...
    path('alunos/create/', AlunoCreateViewSet.as_view(), name='aluno-create'),
    path('socios/', SocioViewSet.as_view(), name='socio-list'),
    path('socios/create/', SocioCreateViewSet.as_view(), name='socio-create'),
    ...
    path('instrutores/create/', InstrutorCreateViewSet.as_view(), name='instrutor-create'),
